...
import { Globe, MapPin, Brain, ShoppingBag } from 'lucide-react';
  ...
  const projects = [
    {
      ...
      github: '#',
      demo: '#',
      highlight: 'Architected scalable hyperlocal mapping.',
    },
    {
      ...
      github: '#',
      demo: '#',
      highlight: 'Integrated specialized natural language processing.',
    },
    {
      title: 'NutricartAI',
      ...
      github: '#',
      demo: '#',
      highlight: 'Built rapidly during the OpenClaw HackIndia event.',
    }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-start">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="space-y-3 mb-6 h-48 overflow-y-auto relative z-10 text-[11px] leading-relaxed">
                <div>
                ...
                <div className="pt-1">
                  <span className="text-[9px] uppercase font-bold text-nebula-purple block tracking-wider">Impact Highlight</span>
                  <p className="text-gray-300 font-medium italic">{project.highlight}</p>
                </div>
              </div>
              ...
              {/* Action Buttons */}
              <div className="grid grid-cols-2 gap-3 pt-4 border-t border-space-border/50 relative z-10">
                <a
                  href={project.github}
                  aria-label={`View Source code for ${project.title}`}
                  className="flex items-center justify-center space-x-1.5 py-2 px-3 rounded-lg border border-space-border/80 bg-space-dark/50 text-xs text-gray-300 hover:text-white hover:border-gray-500/30 transition-all duration-200 cursor-pointer"
                >
                ...
                <a
                  ...
                  className="flex items-center justify-center space-x-1.5 py-2 px-3 rounded-lg bg-gradient-to-r from-nebula-cyan/80 to-nebula-blue/80 text-space-black font-bold text-xs hover:from-nebula-cyan hover:to-nebula-blue transition-all duration-200 cursor-pointer shadow-[0_0_10px_rgba(0,242,254,0.1)] hover:shadow-[0_0_15px_rgba(0,242,254,0.3)]"
                >
                  <Globe size={13.5} />
                  <span>Live Demo</span>
                </a>
