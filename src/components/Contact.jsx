...
import { Send, Github, Linkedin, Mail, CheckCircle2, Terminal } from 'lucide-react';
...
export default function Contact() {
  ...
  const socialLinks = [
    { name: 'GitHub', url: 'https://github.com/aashu2252', icon: <Github size={20} /> },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center max-w-5xl mx-auto">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-gray-400 font-light leading-relaxed text-sm">
              Whether you need to scale localized search pools for your business with Softappix, require full-stack web integration, or just want to chat about AI fraud detection models, send a wave.
            </p>
